...
const ShowPage = () => {
  return (
    <div className="hidden min-h-screen w-full flex-col bg-[#08080a] border-white/10 border-r-2 text-white md:flex md:w-[60%]">
      {/* Logo */}
      ...
      <div className="flex flex-1 flex-col px-12">
        ...
        <div className="flex flex-1 items-center">
          <div className="max-w-105">
            <h1 className="font-display text-3xl font-bold leading-[1.25] tracking-tight">
